...
<asp:Content ID="cont1" ContentPlaceHolderID="phDS" runat="Server">
	...
	<px:PXDataSource ID="ds" runat="server" Visible="True" PrimaryView="Designs" TypeName="PX.Data.Maintenance.GI.GenericInquiryDesigner">
		...
		<CallbackCommands>
			...
			<px:PXDSCallbackCommand DependOnGrid="grdResults" Name="moveUpResults" Visible="False" CommitChanges="True"/>
			<px:PXDSCallbackCommand DependOnGrid="grdResults" Name="moveDownResults" Visible="False" CommitChanges="True"/>
		...
		<Items>
						...
						<Levels>
							<px:PXGridLevel  DataMember="Results">
								<RowTemplate>
								    ...
								    <px:PXDropDown ID="edNavigateTo" runat="server" DataField="NavigateTo" CommitChanges="True" />
								</RowTemplate>
								<Columns>
									...
									<px:PXGridColumn DataField="Field" Width="150px" CommitChanges="true" />
									<px:PXGridColumn DataField="SchemaField" Type="DropDownList" Width="150px" />
									<px:PXGridColumn DataField="Caption" Label="Caption" Width="108px" />
								    ...
								    <px:PXGridColumn DataField="NavigateTo" Width="150px" Type="DropDownList" CommitChanges="True" />
								</Columns>
							</px:PXGridLevel>
						</Levels>
						<AutoSize Enabled="true" MinHeight="150" />
			...
			<px:PXTabItem Text="Entry Point" RepaintOnDemand="false">
				<Template>
					...
					<px:PXTreeSelector ID="edPrimaryScreen" runat="server" DataField="PrimaryScreenID" PopulateOnDemand="False" AutoRefresh="true"
						ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="PrimaryScreenTree" MinDropWidth="413" CommitChanges="true">
						<DataBindings>
							<px:PXTreeItemBinding DataMember="PrimaryScreenTree" TextField="Title" ValueField="ScreenID" ImageUrlField="Icon" ToolTipField="TitleWithPath" />
						</DataBindings>
					</px:PXTreeSelector>
                    ...
                    <px:PXSplitContainer runat="server" PositionInPercent="true" SplitterPosition="25" Width="100%">
                        ...
                        <Template1>
                            <px:PXGrid ID="grdNavScreens" runat="server" DataSourceID="ds" Style="z-index: 100" Width="100%" Caption="Screens" SkinID="Details"
                                ...
                                <Levels>
                                    <px:PXGridLevel DataMember="NavigationScreens" SortOrder="CreatedDateTime">
                                        <RowTemplate>
                                            <px:PXTreeSelector ID="edNavScreen" runat="server" DataField="ScreenID" PopulateOnDemand="False" AutoRefresh="true"
						                        ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="SiteMapTree" MinDropWidth="413" CommitChanges="true">
						                        <DataBindings>
                        ...
                        <Template2>
                            <px:PXFormView ID="frmNavWindowMode" runat="server" DataMember="NavigationScreens" AllowPaging="False"> 
                                <Searches>
                                    ...
                                    <px:PXControlParam Name="ScreenID" ControlID="grdNavScreens" PropertyName="DataValues[&quot;ScreenID&quot;]" />
                                </Searches>
                                <Template>
