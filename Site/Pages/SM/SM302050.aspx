...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="formBPEvent" runat="server" DataSourceID="ds" Style="z-index: 100" 
        ...
        <Template>
            ...
            <px:PXCheckBox Size="M" runat="server" DataField="Active" ID="edActive" AlreadyLocalized="False" />
            ...
            <px:PXTreeSelector CommitChanges="True" ID="edScreenID" runat="server" DataField="ScreenID" PopulateOnDemand="True"
                            ShowRootNode="False" TreeDataSourceID="ds" TreeDataMember="SiteMap" MinDropWidth="413" AlreadyLocalized="False" Size="M">
                <DataBindings>
            ...
            <px:PXLayoutRule runat="server" StartColumn="True" ControlSize="S" LabelsWidth="S" />
             <px:PXLabel ID="PXLabel1" runat="server" AlreadyLocalized="False"></px:PXLabel>
             <px:PXLabel ID="PXLabel2" runat="server" AlreadyLocalized="False"></px:PXLabel>
             <px:PXButton ID="edInquiryParameters" runat="server" Text="INQUIRY PARAMETERS" AlignLeft="True" AlreadyLocalized="False" AutoRefresh="True" AutoAdjustColumns="True" 
                    ...
                    <px:PXGrid ID="gridSchedules" runat="server" DataSourceID="ds" Height="150px" Style="z-index: 100" AutoRefresh="True" AutoAdjustColumns="True"
                        ...
                        <Levels>
                            <px:PXGridLevel DataMember="Schedules">
                                ...
                                <Columns>
                                    <px:PXGridColumn DataField="Active" Width="60" Type="CheckBox" TextAlign="Center" AllowResize="false"/>
                                    <px:PXGridColumn DataField="ScheduleID" Width="300" LinkCommand="viewSchedule" CommitChanges="True"/>
