...
<body>
    ...
    <div class="main">
        <px:PXFormView ID="frmBottom" runat="server" SkinID="Transparent">
            <Template>
                <div class="errCode">
                    <px:PXLabel ID="lblErrCode" runat="server" Text="Error code" CssClass="errCode"></px:PXLabel>
                </div>
                <div class="grayBox">
                    <div class="img">
                    ...
                    <div class="errMsg">
                        <px:PXLabel ID="lblMessage" CssClass="errMsg" runat="server" Text="We're sorry! An error has occurred while processing your request. A report has been generated for our technical staff to investigate the problem. Please try to repeat your request later. Thank you for understanding."></px:PXLabel>
                    </div>
                </div>
                <div class="traceLnk">
