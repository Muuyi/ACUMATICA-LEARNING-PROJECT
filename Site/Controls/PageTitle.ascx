...
<div runat="server" id="pnlDialogs">
	...
	<px:PXSmartPanel ID="pnlAudit" runat="server" CaptionVisible="True" DesignView="Hidden"	Caption="Update History" Overflow="Hidden" 
		...
		Width="635" Height="500" Caption="Share Column Configuration" Key="ShareColumnsFilter" CaptionVisible="false" LoadOnDemand="true" AutoReload="true" 
			...
			<Pages>
				...
				<px:PXWizardPage Caption="Share Column Configuration Page 2 of 2">
					<Template>
						...
						<px:PXGrid ID="userGrid" Caption="User name" AutoAdjustColumns="true" Width="100%" SkinID="Details" runat="server" NoteIndicator="false" AdjustPageSize="Auto"
